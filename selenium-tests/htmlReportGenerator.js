// selenium-tests/htmlReportGenerator.js
// Generates a dark-themed HTML execution report from Selenium test results
...
<head>
  ...
  <title>Style AI — Selenium E2E Test Report</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .header {
      background: linear-gradient(135deg, #1f3864 0%, #2d6a9f 100%);
      padding: 32px 40px;
    ...
    thead th { background: #1f3864; color: #ffffff; padding: 12px 16px; font-size: 12px; text-align: left; text-transform: uppercase; letter-spacing: 0.5px; }
    ...
    .td-id   { font-family: monospace; color: #58a6ff; font-weight: 600; white-space: nowrap; }
...
<body>
  <div class="header">
    <h1>🧪 Style AI — Selenium E2E Test Execution Report</h1>
    <p>Generated: ${generatedAt} &nbsp;|&nbsp; Framework: Selenium WebDriver (Chrome Headless) &nbsp;|&nbsp; Environment: Web (Next.js)</p>
  </div>
  ...
  <div class="footer">
    Style AI Selenium E2E Test Suite &nbsp;•&nbsp; Auto-generated by htmlReportGenerator.js
  </div>
</body>
</html>`;
