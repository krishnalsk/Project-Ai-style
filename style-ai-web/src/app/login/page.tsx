...
export default function LoginPage() {
  ...
  function handleDemoAccess() {
    demoLogin("Style Explorer", email.trim() || "guest@styleai.app");
    router.push("/dashboard");
  }
  ...
  return (
    <main className="flex-1 flex items-center justify-center min-h-screen bg-gradient-to-br from-white via-blue-50 to-indigo-50 px-4">
      <div className="max-w-md w-full glass rounded-3xl p-10 shadow-xl border border-blue-100">
        ...
        <p className="text-slate-500 text-sm mb-8">Sign in to your Style AI account.</p>
...
function friendlyError(msg: string): string {
  if (msg.includes("auth/unauthorized-domain")) {
    return "Firebase Auth Domain Notice: GitHub Pages domain is not yet whitelisted in Firebase Console. You can click 'Instant Demo Access' above to explore immediately, or whitelist 'krishnalsk.github.io' in Firebase Console.";
  }
